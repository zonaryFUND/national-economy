...
import { BlankBed, available, unavailable, assertAffectResolve, TestPlayerBlue, TestPlayerRed, assertAffectIOResolve } from "../../bed";
...
describe("設計事務所", () => {
    ...
    it("使用して選んだ1枚を手札に加え、残りを捨て札にする", () => {
        assertAffectResolve(availableBed, designOffice, {targetIndex: 2}, [
    ...
    it("シャッフルが必要なときに使用するとそうした上で山札の上から5枚見て選んだ1枚を手札に加え、残りを捨て札にする", () => {
        ...
        assertAffectIOResolve(shuffleIO, designOffice, {targetIndex: 2}, [
            [
                "捨て札がシャッフルされ、山札の下に補充されました",
                "redが山札の上から社宅、自動車工場、製鉄所、農協、設計事務所をめくり、製鉄所を手札に加えて残りを捨て札にしました"
            ],
            {
                ...availableBed,
                board: {
